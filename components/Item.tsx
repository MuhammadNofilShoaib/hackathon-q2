...
const Item = () => {
    ...
    return (
        <div>
            {loading ? ( // Show loading text when loading is true
                ...
                <div
                    className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 custom:grid-cols-4 justify-center items-center gap-[30px] mx-5 md:mx-[56.6px] mb-[56.6px] justify-items-center"
                >
                    {sanityData.map((item) => (
                        <div key={item._id}>
